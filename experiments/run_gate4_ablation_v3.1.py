...
class AblationRunner:
    ...
    def _evaluate_selection(
        ...
        metrics['runner_version'] = 'v3.1'  # 버전 태그
        ...
        print(f"  ✅ Saved: {results_dir} (+ effective_pairs.json, fragile_z_before.npy)")
    ...
    def _save_run_artifacts(
        ...
        manifest = {
            ...
            'artifacts': [
                ...
                'fragile_z_before.npy',      # P1 가드 추가
                'effective_pairs.json',       # P1 가드 추가
    ...
    def _generate_summary(self, all_results: Dict[str, AblationRunResult]) -> Dict[str, Any]:
        ...
        if dopt_result.status == 'completed' and dopt_metrics:
            runs_list.append({
                ...
                'ceiling_margin': dopt_metrics.get('ceiling_margin'),  # P2 가드
                # Secondary metrics
        ...
        for r in random_results:
            if r.status == 'completed' and r.metrics:
                runs_list.append({
                    ...
                    'ceiling_margin': r.metrics.get('ceiling_margin'),  # P2 가드
                    # Secondary metrics
        ...
        summary = {
            ...
            'comparison': {
                'd_optimal': {
                    ...
                    'ceiling_margin': dopt_metrics.get('ceiling_margin') if dopt_metrics else None,  # P2 가드
                    # Secondary
