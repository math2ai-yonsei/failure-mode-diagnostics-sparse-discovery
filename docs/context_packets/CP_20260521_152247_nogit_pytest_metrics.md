# Context Packet: 20260521_152247_nogit_pytest_metrics
...
python experiments/run_gate0.py ^
  ...
  --n_train 10 --seed 0 ^
  --track standardized --note pytest_metrics
```

## Results 경로

```
C:\python_work\PhD_project_release\results\cartpole_ood_v1\gate0\standardized\sindy\n10\seed0\20260521_152247_nogit_pytest_metrics
```
...
---
*Generated: 2026-05-21T15:22:48.839598*
