...
def compute_gram_contributions_by_target(
    ...
    Args:
        ...
        gram_energy_mode: 'raw' or 'unit_trace'
    ...
    for t, F_t in F_by_target.items():
        ...
        for i in range(N):
            ...
            # v0.3.2: Energy-neutral normalization (GPT P1 recommendation)
...
def track_b_dopt_selection(
    ...
    """
    Track B Selection v0.3.2: D-optimal on fragile features (Θ_F).
    ...
    Args:
        ...
        gram_energy_mode: 'raw' (original) or 'unit_trace' (energy-neutral)
    ...
    Returns:
        Dict with selected trajectories, artifacts, and metadata
    """
    print(f"\n[Track B Selection v0.3.2 D-opt] n_select={n_select}")
    ...
    print(f"  gram_energy_mode={gram_energy_mode}")  # v0.3.2
    ...
    # 5. Compute Gram contributions per target (v0.3.2: energy mode)
    print(f"  Computing Gram contributions (mode={gram_energy_mode})...")
    G_by_target, trace_by_target = compute_gram_contributions_by_target(
        Theta, F_by_target, gram_energy_mode=gram_energy_mode
    )
    ...
    # 8. Build feature spec (v0.3.2 with SSOT enhancements)
    feature_spec = {
        'version': 'v0.3.2',  # Version bump for energy-neutral + SSOT
        'method': 'd_optimal',
    ...
    if results_dir is not None:
        ...
        # v0.3.2 GPT 권장: trace_by_target (에너지 분석용)
    ...
    result = {
        ...
        'stats': {
            ...
            'version': 'v0.3.2',  # Energy-neutral + SSOT
            'lambda_reg': lambda_reg,
            'gram_energy_mode': gram_energy_mode,  # v0.3.2
            'use_teacher_intersection': use_teacher_intersection,
            'pre_gate_mode': pre_gate_mode,
...
def parse_args():
    ...
    parser.add_argument('--track_b_dopt_gram_energy_mode', type=str, default='raw',
                        choices=['raw', 'unit_trace'],
                        help='D-optimal v0.3.2: Gram energy mode (raw=original, unit_trace=energy-neutral)')
