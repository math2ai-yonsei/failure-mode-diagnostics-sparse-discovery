"""
AEK-4c: Random Selection Augmentation Runner (Reparam-1)
...
def save_run(
    ...
    manifest = {
        ...
        'runner': 'experiments/run_aek4c_random.py',
        'runner_version': RUNNER_VERSION,
        'pool_sha': pool_sha,
...
class AEK4cRunner:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        print("=" * 70)
        print("AEK-4c: Random Selection Augmentation (Reparam-1)")
        ...
        results_base = paths.ROOT / 'results' / cfg.dataset_version / 'gate4c' / 'random'
        all_results = {}
        ...
        for sel_seed in cfg.random_seeds:
            ...
            try:
                ...
                # Save
                run_id = paths.generate_run_id(f"aek4c_random_s{sel_seed}")
        ...
        if completed:
            ...
            # Save summary JSON
            summary = {
                'system': 'aek', 'gate': 'gate4c', 'method': 'random',
                'reparam': cfg.reparam,
            ...
            summary_path = results_base / 'aek4c_random_summary.json'
...
def parse_args():
    p = argparse.ArgumentParser(description='AEK-4c Random Augmentation')
